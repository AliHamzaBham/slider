...
(function () {
  function ElderSlider(selector, opts) {
    this.wrapper = null;
    this.wrapperWidth = 0;
    this.track = null;
    this.trackWidth = 0;
    ...
    this.lastItem = null;
    this.settings = _objectSpread({}, ElderSlider.defaults, opts);
  ...
  ElderSlider.prototype.next = function () {
  ...
  ElderSlider.prototype.prev = function () {
  ...
  ElderSlider.prototype.goTo = function (index) {
    this.trackPosition = -(index * this.itemWidth);
    move(this);
  };

  ElderSlider.prototype.play = function () {
    var _this = this;
  ...
  ElderSlider.prototype.stop = function () {
    clearInterval(this.playInterval);
  };
  ...
  window.ElderSlider = ElderSlider;
})();
